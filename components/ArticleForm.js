  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="article-form">
      ...
      <div className="article-form__field">
        ...
        <input className="article-form__input" id="slug" {...register("slug")} />
        {errors.slug && (
          <p className="article-form__error" role="alert">
            {errors.slug.message}
          </p>
      ...
      {/* CONTENT */}
      <div className="article-form__field">
        <label className="article-form__label" htmlFor="content">Contenu</label>
        <textarea className="article-form__textarea" id="content" {...register("content")} rows={8} />
        {errors.content && (
          <p className="article-form__error" role="alert">
